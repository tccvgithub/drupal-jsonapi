...
export async function contasPrestadas(token: string): Promise<Array<ContaPrestada>> {
...
export async function consultarRecursosFiscalizados(token: string): Promise<Array<ContaPrestada>> {
